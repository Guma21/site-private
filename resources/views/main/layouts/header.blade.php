    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                <h1 class="text-primary"><i class="fas fa-laptop-code me-3"></i>Guma21</h1>
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="file-stocker/img/carousel1.jpg" class="img-fluid w-100" alt="Image">
            ...
            <div class="header-carousel-item">
                <img src="file-stocker/img/carousel2.jpg" class="img-fluid w-100" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row g-5">
