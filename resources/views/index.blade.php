...
<head>
    <meta charset="utf-8">
    <title>Guma - My Personal Website</title>
    ...
    <link rel="stylesheet" href="file-stocker/lib/animate/animate.min.css" />
    <link rel="stylesheet" href="file-stocker/lib/lightbox/css/lightbox.min.css">
    <link rel="stylesheet" href="file-stocker/lib/owlcarousel/assets/owl.carousel.min.css">

    <!-- Customized Bootstrap Stylesheet -->
    <link rel="stylesheet" href="file-stocker/css/bootstrap.min.css">

    <!-- Template Stylesheet -->
    <link rel="stylesheet" href="file-stocker/css/style.css">
</head>
...
<body>
        ...
        <div class="row gx-0 align-items-center">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-flex flex-wrap">
                    <a href="tel:+6285123563900" class="text-muted small me-4"><i
                            class="fas fa-phone-alt text-primary me-2"></i>+62-851-2356-3900</a>
                    <a href="mailto:rizqiadigumilang@gmail.com" class="text-muted small me-0"><i
                            class="fas fa-envelope text-primary me-2"></i>rizqiadigumilang@gmail.com</a>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                ...
                <!-- <img src="file-stocker/img/logo.png" alt="Logo"> -->
            </a>
        ...
        <div class="header-carousel owl-carousel">
            <div class="header-carousel-item">
                <img src="file-stocker/img/carousel-1.jpg" class="img-fluid w-100" alt="Image">
            ...
            <div class="header-carousel-item">
                <img src="file-stocker/img/carousel-2.jpg" class="img-fluid w-100" alt="Image">
                <div class="carousel-caption">
                    <div class="container">
                        <div class="row g-5">
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="bg-primary rounded position-relative overflow-hidden">
                        ...
                        <div class="rounded-bottom">
                            <img src="file-stocker/img/about-5.jpg" class="img-fluid rounded-bottom w-100"
                                alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="container pb-5">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="file-stocker/img/service-1.jpg" class="img-fluid rounded-top w-100"
                                alt="Image">
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="file-stocker/img/service-2.jpg" class="img-fluid rounded-top w-100"
                                alt="Image">
                        </div>
                        <div class="rounded-bottom p-4">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="file-stocker/img/service-3.jpg" class="img-fluid rounded-top w-100"
                                alt="Image">
                        </div>
                        <div class="rounded-bottom p-4">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="file-stocker/img/service-4.jpg" class="img-fluid rounded-top w-100"
                                alt="Image">
                        </div>
                        <div class="rounded-bottom p-4">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="file-stocker/img/service-5.jpg" class="img-fluid rounded-top w-100"
                                alt="Image">
                        </div>
                        <div class="rounded-bottom p-4">
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="file-stocker/img/service-6.jpg" class="img-fluid rounded-top w-100"
                                alt="Image">
                        </div>
                        <div class="rounded-bottom p-4">
    ...
    <script src="file-stocker/lib/wow/wow.min.js"></script>
    <script src="file-stocker/lib/easing/easing.min.js"></script>
    <script src="file-stocker/lib/waypoints/waypoints.min.js"></script>
    <script src="file-stocker/lib/counterup/counterup.min.js"></script>
    <script src="file-stocker/lib/lightbox/js/lightbox.min.js"></script>
    <script src="file-stocker/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Template Javascript -->
    <script src="file-stocker/js/main.js"></script>
</body>
